...
module.exports = (robot) ->
  ...
  robot.router.get '/meme/:imageName', (req, res) ->
    ...
    # TODO: Save to tmpdir, and serve from there
  ...
  robot.respond /(NOT SURE IF .*) (OR .*)/i, (msg) ->
    memeGenerator msg, 'fry.jpg', msg.match[1], msg.match[2], (url) ->
      msg.send url
  ...
  robot.respond /WHAT IF I TOLD YOU (.*)/i, (msg) ->
    memeGenerator msg, 'what-if-i-told-you.jpg', 'WHAT IF I TOLD YOU', msg.match[1], (url) ->
      msg.send url
